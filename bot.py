...
def invalid_message(lang):
    return "من فضلك اكتب سؤال واضح." if lang == "ar" else "Please write a clear question."

def unknown_answer_message(lang):
    return "عذراً، لا أملك معلومات كافية للإجابة على هذا السؤال." if lang == "ar" else "Sorry, I don't have enough information to answer that question."
